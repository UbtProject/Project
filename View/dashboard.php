				...
				<table class="align-center table-bordered dashboard-table">
					...
					foreach($users as $user){?>
						<tr>
							...
							<td class="align-text-center"><a href='../Controller/deleteUser.php?id=<?=$user["ID"]?>'><button class="deleteBtn">Delete</button></a></td>
						</tr>
					<?php
					}
					?>
				...
				<table class="align-center table-bordered dashboard-table">
					...
					foreach($animals as $animal){?>
						<tr>
							...
							<td class="align-text-center"><a href='../Controller/deleteAnimal.php?id=<?=$animal["ID"]?>'><button class="deleteBtn">Delete</button></a></td>
						</tr>
					<?php
					}
					?>
