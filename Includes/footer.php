		...
		<div class="first-box" style="padding: 10px;">
			...
			<div class="right-footer">
				<div class="info-footer">
					<h1 class="">about</h1>
					<p>Founded Time: <b>2021</b></p>
					<p>Location: <b>Prishtine, Kosovo</b></p>
					<p>Number of animals sheltered: <b>1024</b></p>
				</div>
				<div class="info-footer">
					<h1 class="monospace">contact</h1>
					<p>043 800 745</p>
					<p>044 827 361</p>
				</div>
				<div class="info-footer">
					<h1 class="monospace">Team</h1>
					<p>Dije Ferati</p>
					<p>Dion Osmani</p>
				</div>
			</div>
